...
namespace SalesDashboard
{
    public class SalesTrendsViewModel : BaseViewModel
    {
        ...
        public SalesTrendsViewModel(SalesDataService salesDataService)
        {
            ...
            ProductInfos = new()
            {
                new ProductInfo { Product = "Samsung Galaxy S3", BuyingPrice = 149.99, Image = ImageSource.FromFile(""), ProductStockCount = 14, AvailabilityImage = ImageSource.FromFile("correct.png") },
                ...
                new ProductInfo { Product = "Google Nexus 5", BuyingPrice = 129.99, Image = ImageSource.FromFile(""), ProductStockCount = 2, AvailabilityImage = ImageSource.FromFile("correct.png")  },
                ...
                new ProductInfo { Product = "LG G2", BuyingPrice = 149.99, Image = ImageSource.FromFile(""), ProductStockCount = 16 , AvailabilityImage = ImageSource.FromFile("correct.png") },

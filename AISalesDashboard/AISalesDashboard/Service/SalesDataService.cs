namespace AISalesDashboard
{
    public class SalesDataService
    {
        ...
        private void LoadSampleData()
        {
            ...
            {
                new Product { Id = "P001", Name = "iPhone 5S", Category = "Electronics", BasePrice = 999.99m, IsActive = true, Icon="iphone_5s.png" },
                ...
                new Product { Id = "P004", Name = "iPhone 4", Category = "Wearables", BasePrice = 249.99m, IsActive = true, Icon="iphone_4.png" },

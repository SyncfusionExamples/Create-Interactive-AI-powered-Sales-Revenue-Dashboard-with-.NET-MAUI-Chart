...
namespace AISalesDashboard
{
    public class SalesTrendsViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<PageInfo>? pages;
        ...
        public SalesTrendsViewModel(SalesDataService salesDataService)
        {
            Pages = new ObservableCollection<PageInfo>()
                {
                    new PageInfo(){ Title = "Home", PageIcon="home_dark.png"},
                    new PageInfo(){ Title = "Products", PageIcon="product_dark.png"},
                    new PageInfo(){ Title = "Orders", PageIcon="orders_dark.png"},
                    new PageInfo(){ Title = "Predictions", PageIcon="prediction_dark.png"}
                };
        ...
        public async Task LoadSalesData()
        {
            try
            {
                ...
                {
                    new SalesData { Date = new DateTime(2024, 1, 1), Revenue = 920000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 2, 1), Revenue = 1030000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 3, 1), Revenue = 1180000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 4, 1), Revenue = 1380000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 5, 1), Revenue = 1620000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 6, 1), Revenue = 1580000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 7, 1), Revenue = 1400000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 8, 1), Revenue = 1200000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 9, 1), Revenue = 1020000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 10, 1), Revenue = 940000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 11, 1), Revenue = 910000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) },
                    new SalesData { Date = new DateTime(2024, 12, 1), Revenue = 900000, Quantity = random.Next(200,1000), Cost = random.Next(500000, 900000) }
                };
